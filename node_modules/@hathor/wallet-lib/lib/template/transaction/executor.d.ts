 ...
 */
import { z } from 'zod';
import { AuthorityOutputInstruction, AuthoritySelectInstruction, ChangeInstruction, CompleteTxInstruction, ConfigInstruction, DataOutputInstruction, RawInputInstruction, RawOutputInstruction, SetVarInstruction, ShuffleInstruction, TokenOutputInstruction, TxTemplateInstruction, UtxoSelectInstruction } from './instructions';
 ...
 */
export declare function execChangeInstruction(interpreter: ITxTemplateInterpreter, ctx: TxTemplateContext, ins: z.infer<typeof ChangeInstruction>): Promise<void>;
/**
